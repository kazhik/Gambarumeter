...
public class ChartView {
    ...
    public void load(List<SplitTimeStepCount> splits) {
        ...
        LineDataSet hrSet =
                new LineDataSet(yHeartRate, this.context.getString(R.string.heart_rate));
        LineDataSet stepSet =
                new LineDataSet(ySteps, this.context.getString(R.string.stepLabel));
        LineDataSet lapSet =
                new LineDataSet(yLap, this.context.getString(R.string.lap));
